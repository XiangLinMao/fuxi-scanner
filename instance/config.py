...
class Config:
    ...
    AWVS_URL = 'https://192.168.1.180:3443'  # Acunetix Web Vulnerability Scanner Url
    AWVS_API_KEY = "1986ad8c0a5b3df4d7028d5f3c06e936ccd3d8fa6ac7240868e39c1afd4fda3f4"  # Acunetix Web Vulnerability Scanner API Key
